...
/* ==================================================
	header
================================================== */
#header{width:100%; position:relative; z-index:99; width:1600px; margin:0; padding:0; height:156px;  border-bottom:2px solid #B24040;}
#header h1{position:absolute; left:10px; top:5px;}
#header .topmenu{position:absolute; right:10px; top:20px;}
#header .topmenu > li{float:right; width:auto; position:relative; margin-left:20px; }
...
/* ==================================================
	contents
================================================== */
#container{clear:both; position:relative; width:1600px; height:100%;  margin-top:-62px; padding-top:62px; }
...
#contentsWrap{position:relative; float:left; height:100%; padding-left:25px; width:1380px}
#menuWrap .allmenu{background:#B24040 url(<%=util.Property.contextPath%>/img/ico_allmenu.png) no-repeat 20px center; height:58px; line-height:58px;color:#fff; font-size:16px; padding-left:50px; position:relative;}
#menuWrap .allmenu .allmenu_con{position:absolute; left:0; width:1200px; top:58px; background:#B24040; z-index:99; display:none; padding:20px 30px 40px 50px;}
...
#menuWrap .login input{color:#484b56; border:none;  font-size:13px; width:110px; height:30px;}
...
.tabWrap{position:relative; width:1380px; height:58px; border-bottom:1px solid #cccccc; background:#e6e6e6; padding:7px 7px 0; overflow:hidden; margin-left:-25px; }
...
.tabWrap .tab li.on{background:#D08180; border:1px solid #D08180; border-bottom:none; color:#fff; }
