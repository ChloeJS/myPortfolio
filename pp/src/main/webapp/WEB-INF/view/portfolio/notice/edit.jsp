		...
		<table>
			...
			<tbody>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" id="notice_title" name="notice_title" value="${view.notice_title }" />
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea id="notice_content" name="notice_content" rows="25">${view.notice_content }</textarea>
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
