...
<div id="boardWrap" class="bbs">
	...
	<!--//search-->
	<div class="write">
		<form name="frm" id="frm" action="addReply.do" method="POST" enctype="multipart/form-data">
		...
		<table>
			...
			<tbody>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" id="title" name="reply_title" value="" />
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea id="contents" name="reply_content" rows="25"></textarea>
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
