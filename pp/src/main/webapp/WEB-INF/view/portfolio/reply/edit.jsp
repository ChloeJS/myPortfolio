...
<div id="boardWrap" class="bbs">
	...
	<div class="write">
		...
		<input type="hidden" name="reply_no" value="${data.reply_no }">
		<table>
			<colgroup>
			...
			<tbody>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" id="title" name="reply_title" value="${data.reply_title }" />
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea id="contents" name="reply_content" rows="25">${data.reply_content }</textarea>
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
